        ...
        <div class="modal-dialog horoscope-ui">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Gift Category</h4>
                </div>
                <div class="modal-body">
                    {!!Form::open(['url'=>URL::route('gift.category.add'), 'class'=>'dev-cat-form'])!!}
                    <div class="row">
                        <div class="">
    ...
    <script>
        ...
        $(function () {
            ...
            var $catTable = $('.dev-cat-list').DataTable({
                ajax: "{{ URL::route('gift.categories')}}",
                columns: [
                    null,
                    {className: "hidden-xs"},
                    {className: "hidden-xs"},
