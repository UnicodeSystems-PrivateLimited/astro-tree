...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#" class="active">Relations</a></li>
    </ol>
</section>
<section class="content">
            ...
            <div class="box">
                <div class="box-body">
                    <div class="text-right btn-block form-group">
                        <button class="btn btn-info" data-toggle="modal" data-target="#add-type"><i class="fa fa-plus">&nbsp;</i> Add New</button>
                    </div>
    ...
    <div id="add-type" class="modal fade" role="dialog">
        <div class="modal-dialog horoscope-ui">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Add Relation Type</h4>
                </div>
                <div class="modal-body">
                    {!!Form::open(['url'=>URL::route('relation.type.add'), 'class'=>'dev-type-form'])!!}
                    <div class="row">
                        <div class="">
                            <div class="col-sm-4 form-group"><label>   {!! Form::label('name','Type:') !!}</label></div>
    ...
    <script>
        ...
        $(function () {
            var $addModel = $('#add-type').on('show.bs.modal', function (event) {
                var $this = $(this);
                $this.find('#cid').val("");
                $this.find('#name').val("");
            ...
            var $relationTable = $('.dev-cat-list').DataTable({
                ajax: "{{ URL::route('relation.types')}}",
                columns: [
                    null,
                    {className: "hidden-xs"},
                    {className: "hidden-xs"},
            ...
            $('.dev-type-form').submit(function (e) {
                e.preventDefault();
                saveForm();
            });
